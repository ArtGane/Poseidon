...
public class UserConstantes {
    ...
    public static final String USERNAME_ALREADY_TAKEN_EXCEPTION_MESSAGE = "Nom d'utilisateur déjà pris";
    public static final String USER_DELETED_LOG_MESSAGE = "[UserConfiguration] Deleted user with username : %s";
}
